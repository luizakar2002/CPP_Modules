...
{
	std::cout << "Default ctor of ClapTrap has been called" << std::endl;
...
{
	std::cout << "Ctor of ClapTrap has been called" << std::endl;
	this->_name = name;
	this->_hitp = 10;
	this->_energyp = 10;
	this->_attackd = 0;
...
{
	std::cout << "Copy ctor of ClapTrap called" << std::endl;
...
ClapTrap::~ClapTrap( void )
{
	std::cout << "Dtor of ClapTrap has been called" << std::endl;
}
